...
<% 
    ...
    if(loginmsg != null) {
%>
<p style="color: red; font-weight: bold;"><%=loginmsg%></p>
<%
    }
%>
...
<h1 style="text-align: center; color: #007BFF; font-size: 32px; margin-bottom: 30px;">Login</h1>

<form action="login" method="POST" style="max-width: 400px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.1);">
    ...
    <button type="submit" style="width: 100%; padding: 10px; background-color: #28a745; color: white; border: none; border-radius: 5px; font-size: 18px; cursor: pointer;">Login</button>
</form>
